        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span class="info-box-number"><?php echo $newcase ?></span>
               </div>
            ...
            <div class="col-lg-3 col-xs-6">
              ...
              <div class="info-box">
               ...
               <div class="info-box-content">
                 ...
                 <span class="info-box-number"><?php echo $newcase ?><sup style="font-size: 20px">%</sup></span>
               </div>
               <a href="#" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
               <!-- /.info-box-content -->
             </div>
            ...
            <div class="col-lg-3 col-xs-6">
               <div class="info-box">
                  ...
                  <div class="info-box-content">
                    <span class="info-box-text">Opened Cases</span>
                    <span class="info-box-number">65</span>

                  </div>
                  <a href="<?php echo base_url(); ?>cases" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
                  <!-- /.info-box-content -->
                </div>
              <!-- small box -->
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-8">
                  ...
                  <div class="chart">
                    <!-- Sales Chart Canvas -->
                    <canvas id="salesChart" style="height: 180px; width: 705px;" width="705" height="180"></canvas>
                  </div>
                  <!-- /.chart-responsive -->
                </div>
                <!-- /.col -->
